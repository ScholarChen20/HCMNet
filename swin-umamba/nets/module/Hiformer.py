...
def get_hiformer_s_configs():
    ...
    cfg.swin_pretrained_path = "/home/cwq/MedicalDP/SwinUmamba/swin-umamba/pretrained_ckpt/swin_tiny_patch4_window7_224.pth"
...
def get_hiformer():
    Config = {
        'hiformer-s': get_hiformer_s_configs(),
        'hiformer-b': get_hiformer_b_configs(),
        'hiformer-l': get_hiformer_l_configs(),
    }
    model = HiFormer(config=Config['hiformer-s'], img_size=224, n_classes=1).cuda()
    return model
