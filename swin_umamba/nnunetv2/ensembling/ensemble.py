...
def ensemble_folders(list_of_input_folders: List[str],
    ...
    folders contain the same plans etc! This can be a feature if results from different evaluate are to be merged (only
    works if label dict in dataset.json is the same between these evaluate!!!)"""
