...
class ExperimentPlanner(object):
    ...
    def determine_fullres_target_spacing(self) -> np.ndarray:
        ...
        For some evaluate the median is not a good choice. Those are the evaluate where the spacing is very anisotropic
        (for example ACDC with (10, 1.5, 1.5)). These evaluate still have examples with a spacing of 5 or 6 mm in the low
        ...
        # we need to identify evaluate for which a different target spacing could be beneficial. These evaluate have
